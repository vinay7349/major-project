...
const Label = ({ n, text }) => (
  <div className="flex items-center gap-3 mb-5">
    <span className="flex items-center justify-center w-7 h-7 rounded-full bg-[#2D5016] dark:bg-[#8FBF6A] text-white dark:text-[#101411] text-[11px] font-bold tracking-wide">{n}</span>
    <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#2D5016]/80 dark:text-[#8FBF6A]">{text}</span>
  </div>
);
    ...
    <div className={`bg-[#f6f1ea] dark:bg-[#101411] text-[#2D2D2D] dark:text-[#D8DAD3] transition-colors duration-300`}>
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12 py-24 w-full">
          ...
          <Reveal delay={100}>
            <h1 className="text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.05] font-extrabold tracking-[-0.03em] text-[#1a1a1a] dark:text-white max-w-3xl">
              Everything local retail needs,{' '}
              <span className="text-[#2D5016] dark:text-[#8FBF6A]">in one place.</span>
            </h1>
          </Reveal>
          <Reveal delay={200}>
            <p className="mt-6 text-lg text-[#5a5a5a] dark:text-[#A9B3A5] max-w-xl leading-relaxed">
          ...
          <Reveal delay={300}>
            <div className="mt-10 flex flex-wrap gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#2D5016] dark:bg-[#8FBF6A] text-white dark:text-[#101411] text-sm font-semibold rounded-xl hover:bg-[#3a6b1e] dark:hover:bg-[#A3CD82] transition-all duration-300 shadow-lg shadow-[#2D5016]/20 hover:shadow-xl hover:shadow-[#2D5016]/25 active:scale-[0.97]"
              >
                Get Started <ArrowRight className="w-4 h-4" />
              </button>
              <button
                onClick={() => navigate('/about')}
                className="inline-flex items-center gap-2 px-7 py-3.5 border border-[#2D2D2D]/15 dark:border-white/25 text-[#2D2D2D] dark:text-[#D8DAD3] text-sm font-semibold rounded-xl hover:bg-[#2D2D2D]/5 dark:hover:bg-white/10 transition-all duration-300"
              >
                Learn More
              </button>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-28">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div>
            <Reveal delay={80}>
              <h2 className="text-3xl lg:text-4xl font-extrabold tracking-[-0.02em] text-[#1a1a1a] dark:text-white mb-4">
                Run your shop <br className="hidden sm:block" />with clarity.
              </h2>
            </Reveal>
            <Reveal delay={140}>
              <p className="text-[#6b6b6b] dark:text-[#A9B3A5] leading-relaxed mb-10 max-w-md">
            ...
            <div className="grid grid-cols-2 gap-4">
              {([
                ...
                <Reveal key={i} delay={200 + i * 60}>
                  <div className="group bg-white dark:bg-[#1A211A] rounded-2xl p-5 border border-stone-100 dark:border-white/10 hover:border-[#2D5016]/20 dark:hover:border-[#8FBF6A]/40 hover:shadow-lg hover:shadow-[#2D5016]/5 transition-all duration-300">
                    <div className="w-10 h-10 rounded-xl bg-[#2D5016]/8 dark:bg-[#8FBF6A]/12 flex items-center justify-center mb-3 group-hover:bg-[#2D5016]/14 dark:group-hover:bg-[#8FBF6A]/20 transition-colors">
                      <f.icon className="w-5 h-5 text-[#2D5016] dark:text-[#8FBF6A]" />
                    </div>
                    <h3 className="font-bold text-sm text-[#1a1a1a] dark:text-white mb-1">{f.title}</h3>
                    <p className="text-xs text-[#777] dark:text-[#9BA59A] leading-relaxed">{f.desc}</p>
                  </div>
                </Reveal>
              ))}
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {([
              ...
              <Reveal key={i} delay={150 + i * 70}>
                <div className="group bg-white dark:bg-[#1A211A] rounded-2xl p-6 border border-stone-100 dark:border-white/10 hover:shadow-lg transition-all duration-300">
                  ...
                  <h3 className="font-bold text-[15px] text-[#1a1a1a] dark:text-white mb-2">{f.title}</h3>
                  <p className="text-xs text-[#777] dark:text-[#9BA59A] leading-relaxed">{f.desc}</p>
                </div>
              </Reveal>
            ))}
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-28">
        ...
        <Reveal delay={60}>
          <h2 className="text-3xl lg:text-4xl font-extrabold tracking-[-0.02em] text-[#1a1a1a] dark:text-white mb-4 max-w-lg">
            Find what you need,<br />right near you.
          </h2>
        </Reveal>
        <Reveal delay={120}>
          <p className="text-[#6b6b6b] dark:text-[#A9B3A5] leading-relaxed mb-12 max-w-xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {([
            ...
            <Reveal key={i} delay={150 + i * 70}>
              <div className="group bg-white dark:bg-[#1A211A] rounded-2xl overflow-hidden border border-stone-100 dark:border-white/10 hover:shadow-xl hover:shadow-[#2D5016]/5 hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="p-5">
                  <div className="w-9 h-9 rounded-lg bg-[#2D5016]/8 dark:bg-[#8FBF6A]/12 flex items-center justify-center mb-3">
                    <f.icon className="w-4 h-4 text-[#2D5016] dark:text-[#8FBF6A]" />
                  </div>
                  <h3 className="font-bold text-[15px] text-[#1a1a1a] dark:text-white mb-1">{f.title}</h3>
                  <p className="text-xs text-[#777] dark:text-[#9BA59A] leading-relaxed">{f.desc}</p>
                </div>
              </div>
            </Reveal>
      ...
      <section className="bg-white dark:bg-[#101411]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-28">
          ...
          <Reveal delay={60}>
            <h2 className="text-3xl lg:text-4xl font-extrabold tracking-[-0.02em] text-[#1a1a1a] dark:text-white mb-12 max-w-lg">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {([
              ...
              { icon: ShieldCheck, title: 'Role-Based Access', desc: 'Admin, Shop Owner, and Customer roles with granular permission controls.', accent: '#4a7c2a' },
              ...
              <Reveal key={i} delay={100 + i * 70}>
                <div className="group flex flex-col h-full bg-[#f9f7f3] dark:bg-[#161D16] rounded-2xl p-6 border border-stone-100 dark:border-white/10 hover:bg-[#f0ede6] dark:hover:bg-[#1C241C] hover:border-[#2D5016]/15 dark:hover:border-[#8FBF6A]/30 transition-all duration-300">
                  <div className="w-11 h-11 rounded-xl flex items-center justify-center mb-4" style={{ backgroundColor: `${f.accent}10` }}>
                    <f.icon className="w-5 h-5" style={{ color: f.accent }} />
                  </div>
                  <h3 className="font-bold text-[15px] text-[#1a1a1a] dark:text-white mb-2">{f.title}</h3>
                  <p className="text-xs text-[#777] dark:text-[#9BA59A] leading-relaxed flex-1">{f.desc}</p>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-28 text-center">
        ...
        <Reveal delay={100}>
          <h2 className="text-3xl lg:text-[2.75rem] font-extrabold tracking-[-0.03em] text-[#1a1a1a] dark:text-white leading-tight max-w-3xl mx-auto mb-6">
            Built to make local retail simpler, smarter, and easier to discover.
          </h2>
        </Reveal>
        <Reveal delay={200}>
          <p className="text-[#6b6b6b] dark:text-[#A9B3A5] max-w-lg mx-auto mb-10 leading-relaxed">
        ...
        <Reveal delay={300}>
          <button
            onClick={() => navigate('/register?role=owner')}
            className="inline-flex items-center gap-2 px-8 py-4 bg-[#2D5016] dark:bg-[#8FBF6A] text-white dark:text-[#101411] text-sm font-semibold rounded-xl hover:bg-[#3a6b1e] dark:hover:bg-[#A3CD82] transition-all duration-300 shadow-lg shadow-[#2D5016]/20 hover:shadow-xl hover:shadow-[#2D5016]/25 active:scale-[0.97]"
          >
            Get Started <ArrowRight className="w-4 h-4" />
          </button>
        </Reveal>
