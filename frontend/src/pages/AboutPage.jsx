...
const AboutPage = () => {
  return (
    <div
      className="relative isolate min-h-[calc(100vh-5rem)] overflow-hidden bg-navy"
    ...
    >
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-slate/80 text-sm max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <GlassCard className="bg-charcoal/60 border-charcoal space-y-4">
          <div className="w-10 h-10 rounded-xl bg-charcoal/10 text-indigo-400 flex items-center justify-center">
            <Cpu className="w-5 h-5" />
          </div>
          <h3 className="text-xl font-bold text-white">Our Vision</h3>
          <p className="text-slate/80 text-xs leading-relaxed">
        ...
        <GlassCard className="bg-charcoal/60 border-charcoal space-y-4">
          <div className="w-10 h-10 rounded-xl bg-amber/10 text-cyan-400 flex items-center justify-center">
            <Zap className="w-5 h-5" />
          </div>
          <h3 className="text-xl font-bold text-white">Core Pillars</h3>
          <ul className="space-y-2 text-xs text-slate/60">
