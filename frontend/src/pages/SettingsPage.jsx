  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        ...
        <p className="text-xs text-slate/80 mt-1">Configure ShopGenie AI operational defaults and UI themes.</p>
      </div>

      <GlassCard className="bg-charcoal/70 border-charcoal p-8 space-y-6 text-xs">
        {/* Theme Settings */}
        <div className="flex justify-between items-center pb-4 border-b border-charcoal">
          <div>
            ...
            <p className="text-slate/80">Switch between dark mode and light theme</p>
          </div>
          <button
            onClick={toggleTheme}
            className="px-4 py-2 rounded-xl bg-charcoal hover:bg-charcoal text-white font-bold flex items-center gap-2"
          >
        ...
        <div className="flex justify-between items-center pb-4 border-b border-charcoal">
          <div>
            ...
            <p className="text-slate/80">Select currency symbol for POS and invoice rendering</p>
          </div>
          <select
            value={currency}
            onChange={(e) => setCurrency(e.target.value)}
            className="px-4 py-2 rounded-xl bg-charcoal border border-charcoal text-white font-mono"
          >
        ...
        <div className="flex justify-between items-center pb-4 border-b border-charcoal">
          <div>
            ...
            <p className="text-slate/80">Trigger instant alert popup when items cross minimum threshold</p>
          </div>
          <input
            type="checkbox"
